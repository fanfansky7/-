...
- (void)viewDidAppear:(BOOL)animated {
    ...
    NSLog(@"%d",[UIViewController selectedAddressButtonUnArchiver]);
    ...
    _myAddressInfo = [UIViewController selectedAddressUnArchiver];
    [self.addressButton setTitle:_myAddressInfo[@"community"] forState:UIControlStateNormal];
}
